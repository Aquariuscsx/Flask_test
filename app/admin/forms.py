...
class AdminLoginForm(FlaskForm):
    account = StringField(label="管理员帐户",
                          validators=[DataRequired("请输入非空管理员帐户")],
                          description="管理员帐户",
                          render_kw={
                              "class": "form-control",
                              "placeholder": "请输入帐户",
    ...
    pwd = PasswordField(label="管理员密码",
                        validators=[DataRequired("请输入非空管理员密码")],
                        description="管理员密码",
                        render_kw={
                            "class": "form-control",
                            "placeholder": "请输入密码",
...
class TagForm(FlaskForm):
    name = StringField(label="标签",
                       validators=[DataRequired("请输入非空标签名")],
                       description="标签",
                       render_kw={
                           "class": "form-control",
                           "id": "input_name",
